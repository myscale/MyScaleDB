...
function copy_config
{
    ...
    cp -rf $PROJECT_PATH/docker/test/myscale_performance/config/* $PROJECT_PATH/performance_pack/config/.
    set_listen_config
...
function copy_scripts
{
    ...
    # cp -rf $PROJECT_PATH/docker/test/myscale_performance/* $PROJECT_PATH/performance_pack/scripts/.
    rsync -a --exclude={'output/*','packages/*','test_output/*','tests/*','workspace'} $PROJECT_PATH/docker/test/myscale_performance $PROJECT_PATH/performance_pack/.
    mv $PROJECT_PATH/performance_pack/myscale_performance $PROJECT_PATH/performance_pack/scripts
}
