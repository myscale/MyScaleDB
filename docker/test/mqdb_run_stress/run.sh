...
function skip_attach_log_check()
{
    ...
    # mv ck_attack_database_log.tar.gz /test_output
    mv /var/log/clickhouse-server/clickhouse-server.log /test_output/attach_database.log
...
mv /test_output/* $WORKPATH/test_output/.
