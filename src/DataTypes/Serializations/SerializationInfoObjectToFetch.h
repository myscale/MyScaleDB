...
/// Referenced from SerializationInfoTuple
class SerializationInfoObjectToFetch : public SerializationInfo
{
public:
    SerializationInfoObjectToFetch(MutableSerializationInfos elems_, const Settings & settings_);
