...
public:
    ...
    bool preComputed() override { return sparse_search_result && sparse_search_result->computed; }
...
private:
    ...
    SparseSearchResultPtr
    sparseSearch(const MergeTreeData::DataPartPtr & data_part = nullptr, const Search::DenseBitmapPtr filter = nullptr);
};
