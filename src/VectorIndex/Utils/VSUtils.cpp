...
namespace DB
{
static String getMetricTypeFromVectorScanDescriptions(const VSDescriptions & vector_scan_descs)
{
...
void filterPartsMarkRangesByVectorScanResult(
    RangesInDataParts & parts_with_ranges, const VSDescriptions & vector_scan_descs)
{
