...
VSRecomputeTransform::VSRecomputeTransform(
...
IProcessor::Status VSRecomputeTransform::prepare()
{
    /// Check can output.
...
void VSRecomputeTransform::work()
{
...
void VSRecomputeTransform::transform(Chunk & input_chunk, Chunk & output_chunk)
{
    DB::OpenTelemetry::SpanHolder span("VSRecomputeTransform::transform()");
    ...
    LOG_DEBUG(&Poco::Logger::get("VSRecomputeTransform"), "Vector Scan Recompute {} rows", output_chunk.getNumRows());
}

void VSRecomputeTransform::mergeResultForTwoStage(
...
{
    DB::OpenTelemetry::SpanHolder span("VSRecomputeTransform::mergeResultForTwoStage()");
