...
class IndexReadFromPart : public VectorIndexSourceDataReader<T>
{
public:
    using DataChunk = typename VectorIndexSourceDataReader<T>::DataChunk;
    ...
    {
        throw DB::Exception(DB::ErrorCodes::NOT_IMPLEMENTED, "seekg() is not implemented in IndexReadFromPart");
    }
...
private:
    ...
    const Poco::Logger *logger = &Poco::Logger::get("IndexReadFromPart");
...
extern template class IndexReadFromPart<Search::DataType::FloatVector>;
extern template class IndexReadFromPart<Search::DataType::BinaryVector>;
};
