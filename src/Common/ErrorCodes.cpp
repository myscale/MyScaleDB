...
#define APPLY_FOR_ERROR_CODES(M) \
    ...
    M(699, TANTIVY_INDEX_STORE_INTERNAL_ERROR) \
    M(700, TANTIVY_BUILD_INDEX_INTERNAL_ERROR) \
    M(701, TANTIVY_SEARCH_INTERNAL_ERROR) \
    M(702, TANTIVY_INDEX_FILES_SERIALIZE_ERROR) \
    M(703, TANTIVY_INDEX_FILES_DESERIALIZE_ERROR) \
    M(704, ILLEGAL_TEXT_SEARCH) \
    M(705, ILLEGAL_HYBRID_SEARCH) \
    M(706, TANTIVY_INDEX_FILE_MANAGEMENT_ERROR) \
    M(707, TANTIVY_INDEX_CACHE_RELOAD_ERROR) \
    M(708, SPARSE_INDEX_STORE_INTERNAL_ERROR) \
    M(709, SPARSE_BUILD_INDEX_INTERNAL_ERROR) \
    M(710, SPARSE_SEARCH_INTERNAL_ERROR) \
    M(711, SPARSE_INDEX_FILES_SERIALIZE_ERROR) \
    M(712, SPARSE_INDEX_FILES_DESERIALIZE_ERROR) \
    M(713, ILLEGAL_SPARSE_SEARCH) \
    M(714, SPARSE_INDEX_FILE_MANAGEMENT_ERROR) \
    M(715, SPARSE_INDEX_CACHE_RELOAD_ERROR) \
    M(716, SKIP_INDEX_FILES_MANAGER_ERROR) \
    M(717, SKIP_INDEX_FILES_SERIALIZE_ERROR) \
    M(718, SKIP_INDEX_FILES_DESERIALIZE_ERROR) \
    M(719, SKIP_INDEX_BUILD_INTERNAL_ERROR) \
    M(720, SKIP_INDEX_SEARCH_INTERNAL_ERROR) \
\
    M(999, KEEPER_EXCEPTION) \
    M(1000, POCO_EXCEPTION) \
    M(1001, STD_EXCEPTION) \
    M(1002, LICENSE_ERROR) /*MYSCALE_OSS_DELETE_LINE*/ \
